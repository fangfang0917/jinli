...
//        dump($tree_node);
    ...
    public function welcome()
    {
        ...
        //人员总数
        $this->view->assign('total_num', $this->total_num(1));
        //今日的
        $this->view->assign('today_total_num', $this->total_num(2));
        //昨日的
        $this->view->assign('yesterday_total_num', $this->total_num(3));
        //本周的
        $this->view->assign('week_total_num', $this->total_num(4));
        return $this->view->fetch();
    }
}