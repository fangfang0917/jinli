<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/service.html";i:1571811147;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="app-main">
    ...
    <div class="service-header">
        <div class="service-imgbox">
            <img src="__STATIC__/index/img/kefu.png"/>
        </div>
        <div class="service-bot">
            <span>服务热线：<?php echo $Customer['customer_phone']; ?></span>
            <a href="tel:<?php echo $Customer['customer_phone']; ?>" class="r">一键拨号</a>
        </div>
    </div>
    <div class="service-bot-con">
        <ul>
            <li>
                <a href="javascript:;" class="service-bot-cont"  onclick="showtop('<?php echo $Customer['wx']; ?>','客服微信:<?php echo $Customer['customer_wxzh']; ?>','长按识别二维码添加客服')">
                    <div class="service-tex">联系客服</div>
            ...
            <li>
                <a href="javascript:;" class="service-bot-cont"  onclick="showtop('<?php echo $Customer['wxgz']; ?>','锦鲤MoM','长按识别二维码关注公众号')">
                    <div class="service-tex">关注公众号</div>
                    <div class="service-icon">
                        <i class="iconfont icon-youjiantou"></i>
                    </div>
                </a>
            ...
            <li>
                <a href="<?php echo url('user/servicelist'); ?>" class="">
                    <div class="service-tex">常见问题</div>
                    <div class="service-icon">
                        <i class="iconfont icon-youjiantou"></i>
                    </div>
                </a>
...
<script type="text/javascript" src="__STATIC__/index/js/user.js"></script>
<style type="text/css">
    .bg{
        display: none;
    }
