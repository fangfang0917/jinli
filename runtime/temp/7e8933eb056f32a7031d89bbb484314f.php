<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/usertxlist.html";i:1571386826;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="app-main">
    ...
    <div class="record-box">
        <ul>
            <?php if(isset($userTxlist)): if(count($userTxlist) >0): if(is_array($userTxlist) || $userTxlist instanceof \think\Collection || $userTxlist instanceof \think\Paginator): $i = 0; $__LIST__ = $userTxlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li>
                <div class="record-data">
                    <h2><?php echo date('Y-m-d',$vo['add_time']); ?></h2>
                    <span><?php echo date('H:i',$vo['add_time']); ?></span>
                </div>
                <div class="record-con">
                    <h3><?php echo number_format($vo['amount'], 2, '.', ''); ?>元</h3>
                    <span class="ongoing"><?php if($vo['type_status']==1): ?>已完成<?php else: ?>提现中<?php endif; ?></span>
                </div>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; else: ?>
            <li>
                <div class="team-num">
                    <div class="team-imgbox" style="width:4.5rem;">
                        <img src="__STATIC__/index/img/shuigang.png">
                    </div>
                    <div class="team-con" style="font-size: 0.35rem">暂无数据~</div>
                </div>
            </li>
            <?php endif; endif; ?>
        </ul>
