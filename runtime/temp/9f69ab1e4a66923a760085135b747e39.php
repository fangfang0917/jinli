<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/get_money/index.html";i:1569721789;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><?php if($vo['type']==2): ?>初级代理<?php elseif($vo['type'] == 3): ?>中级代理<?php elseif($vo['type']==4): ?>高级代理<?php else: ?>私董<?php endif; ?></td>
            <td><?php echo $vo['getmoney_title']; ?></td>
            <td><?php echo $vo['getmoney_content']; ?></td>
            <td class="f-14">
