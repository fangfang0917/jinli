<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/course_classify/edit.html";i:1575600880;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="hidden" name="course_classify_pic" class="input-text" value="<?php echo isset($vo['course_classify_pic']) ? $vo['course_classify_pic'] :  ''; ?>">
                <input type="file" id="cover" class="cover" name="cover" style="display: none">
                <label for="cover" >
                    <?php if(isset($vo)): if($vo['course_classify_pic']): ?>
                    <img src="<?php echo $vo['course_classify_pic']; ?>" style="width: 100px;height:250px">
                    <?php else: ?>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" name="course_classify_title" value="<?php echo isset($vo['course_classify_title']) ? $vo['course_classify_title'] :  ''; ?>" datatype="*" nullmsg="课程标题不能为空">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" name="sort" value="<?php echo isset($vo['sort']) ? $vo['sort'] :  '0'; ?>" datatype="*" nullmsg="课程标题不能为空">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="course_module" class="select-box">
                    <option value="1" <?php if(isset($vo)): if($vo['course_module']== 1): ?>selected<?php endif; endif; ?>>一排一</option>
                    <option value="2" <?php if(isset($vo)): if($vo['course_module']== 2): ?>selected<?php endif; endif; ?>>一排二</option>
                </select>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
