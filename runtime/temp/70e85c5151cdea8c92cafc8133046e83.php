<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/zjagent.html";i:1575971704;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="form-body">
    <div class="form-box">
        <ul class="form-ul">
            ...
            <li class="self-li-i">
                <span class="ttitle">真实姓名</span> <input class="new" type="text" name="realnamee" placeholder="请填写真是姓名" value=""/>
            </li>
            <li class="self-li-i">
                <span class="ttitle">联系地址</span><input class="new" type="text" name='addr' placeholder="请填写联系地址" value=""/>
            </li>
            <li class="complete p">
                <button class="btn-disabled r on" _zjagent style="pointer-events: auto">完成</button>
            </li>
        </ul>
    </div>
</div>
