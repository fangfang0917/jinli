<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/equityinfo.html";i:1576045667;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<style>
    .z-con{background:#edb6a3;padding:0.21rem;}
    .z-con .topimg{width:100%;height:4rem;background:url(/static/index/img/home/vip-zxj-ch.png);background-size:100% 100%;}
    .z-con .innerzcon{background: #ffd1cb;padding:0.32rem;padding-top:0.4rem;background:#ffd1cb;margin-top:-0.7rem;}
    .z-con .innerzcon img{width: 100%}
</style>
...
<div class="z-con">
    ...
    <div class="innerzcon">
        <?php if(is_array($picArr) || $picArr instanceof \think\Collection || $picArr instanceof \think\Paginator): $i = 0; $__LIST__ = $picArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?>
        <img src="<?php echo $r; ?>" alt="">
