<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/course/getcourseclassify.html";i:1575599575;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;s:79:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/course/form.html";i:1575600518;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td class="f-14">
                <a href="javascript:setchoose('<?php echo $vo['id']; ?>','<?php echo $vo['course_classify_title']; ?>');">选择</a>
            </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
