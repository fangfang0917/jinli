<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/bank.html";i:1575946943;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="form-body">
    <div class="form-box">
        <ul class="form-ul">
            <li class="self-li">
                <span class="ttitle">手机号</span><input class="new" type="number" name="phone"
                                                    readonly  value="<?php echo isset($rigU['phone']) ? $rigU['phone'] :  ''; ?>"/></li>
            <li class="self-li-i">
                <span class="ttitle">真实姓名</span> <input class="new" type="text" name="realname" placeholder="请填写真是姓名" value="<?php echo $rigU['realname']; ?>"/>
            </li>
            <li class="self-li-i">
                <span class="ttitle">身份证号</span><input class="new" type="number" name="card" placeholder="请填写身份证号" value="<?php echo $rigU['card']; ?>"/>
            </li>
            <li class="self-li-i">
                <span class="ttitle">银行账号</span><input class="new" type="number" name="bankcode" placeholder="请填写银行账号" value="<?php echo $rigU['bankcode']; ?>"/>
            </li>
            <li class="self-li-i">
                <span class="ttitle">开户行</span> <input class="new" type="text" name="bankname" placeholder="请填写开户行" value="<?php echo $rigU['bankname']; ?>"/>
            </li>
            <li class="complete p">
                <button class="btn-disabled r" _setrenz>完成</button>
            </li>
        </ul>
    </div>
</div>
...
<script src="__STATIC__/index/ydui/js/ydui.js?v=<?php echo time(); ?>"></script>
<script src="__STATIC__/index/js/user.js?v=<?php echo time(); ?>"></script>
