<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/form/index.html";i:1571798551;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="index-search">
    <div class="search-box">
        ...
        <input type="text" name="where" placeholder="搜索课程/老师/专题" id="search" style="line-height: 0.68rem;">
        <i class="iconfont icon-guanbi bi" style="font-size: .35rem;"></i>
    </div>
    <a href="<?php echo url('index/index'); ?>" style="text-align: center;font-size: .3rem;line-height: 0.68rem;line-height: 0.68rem;width: 17%;color: #108EE9;">取消</a>
</div>
<div class="search-con">
    <div class="detailsbot">
        <div class="search-none">
            <!--<img src="__STATIC__/index/img/sousuo.png?v=<?php echo time(); ?>">-->
        </div>
    </div>
</div>
...
<script type="text/javascript" src="__STATIC__/index/js/form.js?v=<?php echo time(); ?>"></script>
