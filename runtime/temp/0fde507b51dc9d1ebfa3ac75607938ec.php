<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/admin_role/edit.html";i:1488957233;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" value="<?php echo isset($vo['name']) ? $vo['name'] :  ''; ?>" placeholder="" name="name" datatype="*" nullmsg="角色名称不能为空">
            </div>
