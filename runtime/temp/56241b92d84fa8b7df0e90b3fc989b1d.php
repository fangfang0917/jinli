<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:104:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\banner\index.html";i:1573202897;s:105:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\template\base.html";i:1568942460;s:116:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\template\javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td>
                <?php if($vo['banner_type'] == 1): ?> 首页banner图 <?php endif; if($vo['banner_type'] == 2): ?> 锦鲤KIDbanner图 <?php endif; if($vo['banner_type'] == 3): ?> 升级提醒-未获得 <?php endif; if($vo['banner_type'] == 4): ?> 礼包提醒图 <?php endif; if($vo['banner_type'] == 5): ?> 非VIP提醒图 <?php endif; if($vo['banner_type'] == 6): ?> 升级提醒-已获得 <?php endif; if($vo['banner_type'] == 7): ?> 个人中心广告图 <?php endif; if($vo['banner_type'] == 8): ?> 首页课程宣传图 <?php endif; ?>
            </td>
            <td><img src="<?php echo $vo['banner_pic']; ?>" alt="" style="max-width:300px;"></td>
            <td><?php echo !empty($vo['banner_url']) && $vo['banner_url']!=''?$vo['banner_url']:'--'; ?></td>
