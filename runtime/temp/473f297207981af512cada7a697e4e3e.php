<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/course/succ.html";i:1575879488;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576205312;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="zxj-buysuc" >
    <div class="done">
        <img src="__STATIC__/index/img/home/succ.png" alt="">
        <p>购买成功</p>
    </div>
    <a href="<?php echo url('course/detail',array('id'=>$id)); ?>">进入课程</a>
    <div class="joinwx">
        <p class="pone">长按二维码添加小助手微信</p>
        <img src="<?php echo $Customer['wx']; ?>" alt="">
        <p class="ptwo">请添加小鲤客服微信：<?php echo $Customer['customer_wxzh']; ?>,加入社群</p>
    </div>
</div>
