<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/pub/password.html";i:1488957233;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>旧密码：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="password" class="input-text" placeholder="请填写旧密码" name="oldpassword" datatype="/^[\w\W]{6,32}$/" nullmsg="请填写旧密码" errormsg="请填写6-32位任意字符">
            </div>
