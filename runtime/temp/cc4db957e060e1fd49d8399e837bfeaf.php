<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/about/index.html";i:1573002403;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<style>
    ...
    <div class="about-topbox">
        <div class="about-imgbox">
            <img src="<?php echo $about['about_pic']; ?>" style="width: 100%;height: 100%"/>
        </div>
        <div class="about-cen"><?php echo $about['about_bb']; ?></div>
        <div class="about-txt">
            <?php echo htmlspecialchars_decode($about['aboutjl'] ); ?>
        </div>
    </div>
    <div class="about-bot-con">
        <ul>
            <li>
                <a href="<?php echo url('about/plat'); ?>" class="service-bot-contb">
                    <div class="service-tex">平台服务协议</div>
            ...
            <li>
                <a href="<?php echo url('about/userxy'); ?>" class="service-bot-contb">
                    <div class="service-tex">用户服务协议</div>
                    <div class="service-icon">
                        <i class="iconfont icon-youjiantou"></i>
                    </div>
                </a>
            ...
            <li>
                <a href="<?php echo url('about/userhz'); ?>" class="service-bot-contb">
                    <div class="service-tex">商务合作</div>
                    <div class="service-icon">
                        <i class="iconfont icon-youjiantou"></i>
                    </div>
                </a>
    ...
    <div class="about-bot" style="padding-top: 0.72rem;">
        <span>臻课教育 版权所有</span>
        <span>Copyright&copy2019 zhenkejiaoyu.All Rights Reserved.</span>
    </div>
