<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/servicelist.html";i:1573020028;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="common-body">
    <div class="common-box">
        <ul>
            <?php if(isset($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li>
                <div class="common-text">
                    <h1>Q: <?php echo $vo['problem']; ?>？</h1>
                    <p>A:<?php echo $vo['da']; ?></p>
                </div>
            </li>
