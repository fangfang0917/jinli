<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/agent/edit.html";i:1571378906;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="level" id="" class="select-box level">
                    <option value="0" <?php if(isset($vo)): if($vo['level'] == 0): ?>selected<?php endif; endif; ?>>非会员</option>
                    <option value="1" <?php if(isset($vo)): if($vo['level'] == 1): ?>selected<?php endif; endif; ?>>会员</option>
                    <option value="2" <?php if(isset($vo)): if($vo['level'] == 2): ?>selected<?php endif; endif; ?>>团长</option>
                    <option value="3" <?php if(isset($vo)): if($vo['level'] == 3): ?>selected<?php endif; endif; ?>>联创</option>
                    <option value="4" <?php if(isset($vo)): if($vo['level'] == 4): ?>selected<?php endif; endif; ?>>合伙人</option>
                    <option value="5" <?php if(isset($vo)): if($vo['level'] == 5): ?>selected<?php endif; endif; ?>>私董</option>
                </select>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
