...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <!--<div class="row cl">-->
            ...
            <!--<div class="formControls col-xs-6 col-sm-6">-->
                <!--<select name="share_level" id="" class="select-box">-->
                    ...
                    <!--<option value="1" <?php if(isset($vo)): if($vo['share_level']==1): ?>selected<?php endif; endif; ?>><?php echo $levelname['level1']; ?></option>-->
                    <!--<option value="4" <?php if(isset($vo)): if($vo['share_level']==4): ?>selected<?php endif; endif; ?>>代理</option>-->
                    <!--<option value="5" <?php if(isset($vo)): if($vo['share_level']==5): ?>selected<?php endif; endif; ?>><?php echo $levelname['level5']; ?></option>-->
                <!--</select>-->
            <!--</div>-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="hidden" name="share_pic" class="input-text" value="<?php echo isset($vo['share_pic']) ? $vo['share_pic'] :  ''; ?>">
                <input type="file" id="cover" name="cover" class="cover_pic" style="display: none">
                <label for="cover">
                    <?php if(isset($vo)): if($vo['share_pic']): ?>
                    <img src="<?php echo $vo['share_pic']; ?>" style="width:200px;">
                    <?php else: ?>
