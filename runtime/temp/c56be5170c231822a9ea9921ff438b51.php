<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/equity/edit.html";i:1576222379;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="type" class="select-box">
                    <option value="0" <?php if(isset($vo)): if($vo['type'] == 0): ?>selected<?php endif; endif; ?>>请选择代理等级</option>
                    <option value="1" <?php if(isset($vo)): if($vo['type'] == 1): ?>selected<?php endif; endif; ?>><?php echo $levelname['level1']; ?></option>
                    <option value="2" <?php if(isset($vo)): if($vo['type'] == 2): ?>selected<?php endif; endif; ?>><?php echo $levelname['level2']; ?></option>
                    <option value="3" <?php if(isset($vo)): if($vo['type'] == 3): ?>selected<?php endif; endif; ?>><?php echo $levelname['level3']; ?></option>
                    <option value="4" <?php if(isset($vo)): if($vo['type'] == 4): ?>selected<?php endif; endif; ?>><?php echo $levelname['level4']; ?></option>
                    <option value="5" <?php if(isset($vo)): if($vo['type'] == 5): ?>selected<?php endif; endif; ?>><?php echo $levelname['level5']; ?></option>
                    <option value="6" <?php if(isset($vo)): if($vo['type'] == 6): ?>selected<?php endif; endif; ?>>其他</option>
                </select>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <textarea name="equity_pic" id="equity" cols="30" rows="10" style="width: 100%;height: 600px"><?php echo isset($vo['equity_pic']) ? $vo['equity_pic'] :  ''; ?></textarea>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
