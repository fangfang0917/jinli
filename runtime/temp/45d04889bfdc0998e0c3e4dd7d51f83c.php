<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/team.html";i:1576205435;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="team-header">
    <div class="team-header-top">
        <div class="team-header-imgbox">
            <?php if($userinfo['head_type'] == 1): ?>
            <img src="<?php echo $userinfo['head']; ?>" style="width: 100%">
            <?php else: ?>
            <img src="__IMG__/<?php echo $userinfo['head']; ?>" style="width: 100%">
            <?php endif; ?>
        </div>
        <div class="team-header-txt">
            <h1><?php echo $userinfo['nick_name']; ?></h1>
            <h2>所属上级：<?php echo $pname; ?></h2>
        </div>
    </div>
    <div class="team-header-bot">总人数：<?php echo $team['teamcount']; ?></div>
</div>
<div class="team-nav" data-action="tabBox" data-item='content'>
    <a href="javascript:;" class="on" data-tab>待发展会员</a>
    <a href="javascript:;" data-tab>直邀会员</a>
    <a href="javascript:;" data-tab>间邀会员</a>
</div>
<div class="team-list" data-itel-box='content'>
    <div class="straight on" data-tab-iteam>
        <div class="straight-txt">当前人数：<?php echo $team['fteamcount']; ?>人</div>
        <ul>
            <?php if(isset($team['fteam'])): if(count($team['fteam'])>0): if(is_array($team['fteam']) || $team['fteam'] instanceof \think\Collection || $team['fteam'] instanceof \think\Paginator): $i = 0; $__LIST__ = $team['fteam'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li style="background-color: #fff;">
                <div class="straight-con">
            ...
            <li>
                <div class="team-num">
                    <div class="team-imgbox">
                        <img src="__STATIC__/index/img/shuigang.png">
                    </div>
                    <div class="team-con">您还未组建自己的团队~</div>
                </div>
            </li>
            <?php endif; endif; ?>
        </ul>
    </div>
    <div class="straight" data-tab-iteam>
        <div class="straight-txt">当前人数：<?php echo $team['teamzcount']; ?>人</div>
        <ul>
            <?php if(isset($team['teamz'])): if(count($team['teamz'])>0): if(is_array($team['teamz']) || $team['teamz'] instanceof \think\Collection || $team['teamz'] instanceof \think\Paginator): $i = 0; $__LIST__ = $team['teamz'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li>
                <div class="straight-con">
                    <div class="straight-img">
                        <?php if($vo['head_type'] == 1): ?>
    ...
    <div class="straight" data-tab-iteam>
        <div class="straight-txt">当前人数：<?php echo $team['teamjcount']; ?>人</div>
        <ul>
            <?php if(isset($team['teamj'])): if(count($team['teamj'])>0): if(is_array($team['teamj']) || $team['teamj'] instanceof \think\Collection || $team['teamj'] instanceof \think\Paginator): $i = 0; $__LIST__ = $team['teamj'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li>
                <div class="straight-con">
                    <div class="straight-img">
                        <?php if($vo['head_type'] == 1): ?>
