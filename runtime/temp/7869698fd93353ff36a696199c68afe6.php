...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><?php if($vo['type']==6): ?>其他<?php else: ?><?php echo getlevel($vo['type']); endif; ?></td>
            <td>详情</td>
