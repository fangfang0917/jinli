<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:103:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/index\view\index\index.html";i:1576223631;s:105:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/index\view\template\base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="thific">
    <div class="innerific">
        <a href="<?php echo url('user/equityshow'); ?>">
            <img src="__STATIC__/index/img/home/homeicon_vip.png" alt="">
            <p>会员专区</p>
        </a>
        <a href="<?php echo url('goodslist/index',array('id'=>5)); ?>">
            <img src="__STATIC__/index/img/home/homeicon_Offline.png" alt="">
            <p>线下营</p>
        </a>
        <a href="<?php echo url('goodslist/index',array('id'=>10)); ?>">

        <img src="__STATIC__/index/img/home/homeicon_kid.png" alt="">
            <p>锦鲤KID</p>
        </a>
    </div>
</div>
...
<div class="spectj">
    <p class="pone">特别推荐</p>
    <a href="<?php echo url('course/detail',array('id'=>$tuijian['id'])); ?>">
        <div class="done"><img src="<?php echo $courseBanner['banner_pic']; ?>" alt=""></div>
        <div class="dtwo">
            <p class="pon">事业发展</p>
            <p class="pon">魅力修炼</p>
            <p class="pon">家庭幸福</p>
        ...
        <p class="pth"><?php echo $tuijian['course_look']; ?>人已加入学习</p>
    </a>
</div>
<!--灰条-->
<div class="ht"></div>
<!--锦鲤优选-->
<?php if(is_array($classDate) || $classDate instanceof \think\Collection || $classDate instanceof \think\Paginator): $i = 0; $__LIST__ = $classDate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(count($vo['courseData'])>0): if($vo['course_module'] == 2): ?>
            <div class="zchoose">
                <a class="aone" href="<?php echo url('goodslist/index',array('id'=>$vo['id'])); ?>">
                    <p class="pone"><?php echo $vo['course_classify_title']; ?></p>
                    <p class="ptwo">
                        <span>更多</span>
                        <img src="__STATIC__/index/img/home/jiantou.png" alt="">
                    </p>
                </a>
                <div class="zxjclasslist">
                    <?php if(is_array($vo['courseData']) || $vo['courseData'] instanceof \think\Collection || $vo['courseData'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['courseData'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?>
                    <a href="<?php echo url('course/detail',array('id'=>$r['id'])); ?>">
                        <div class="done">
                            <div class="zxjtopimg">
                                <img class="innertopimg" src="<?php echo $r['course_pic1']; ?>" alt="">
                                <img class="zxjqg" src="<?php echo isset($r['course_pic_jiao']) ? $r['course_pic_jiao'] :  ''; ?>" alt="">
                                <p class="ppsee"><img src="__STATIC__/index/img/home/yan.png" alt=""><span><?php echo $r['course_look']; ?></span>人已观看</p>
                            </div>
                            <div class="innerbotword">
                                <p class="ptitle"><?php echo $r['course_title']; ?></p>
                                <?php if($r['is_buy'] == 1): ?>
                                <p class="zxjvip"></p>
                                ...
                                <?php else: ?>
                                <p class="zxjvip">VIP ￥<?php echo $r['course_vip_money']; ?></p>
                                <P class="zxjyj">原价<span><?php echo $r['course_money']; ?></span>元</P>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>
        ...
        <?php else: ?>
           <div class="zxjyx">
        <!--<p class="ptitle"><?php echo $vo['course_classify_title']; ?></p>-->
               <a class="aone" href="<?php echo url('goodslist/index',array('id'=>$vo['id'])); ?>">
                   <p class="pone"><?php echo $vo['course_classify_title']; ?></p>
                   <p class="ptwo">
                       <span>更多</span>
            ...
            <a href="<?php echo url('course/detail',array('id'=>$r['id'])); ?>">
                <div class="done">
                    <div class="zxjleftimg">
                        ...
                        <div class="zxjsee">
                            <img src="__STATIC__/index/img/home/yan.png" alt="">
