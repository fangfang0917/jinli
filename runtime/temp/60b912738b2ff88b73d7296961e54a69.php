<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/txsuccess.html";i:1571464756;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="app-main">
    ...
    <div class="successful-con">
        <div class="successful-img">
            <img src="__STATIC__/index/img/wancheng.png"/>
        </div>
        <div class="successful-text">
            <div class="successful-top">
                提现申请已提交，等待人工审核
            </div>
            <div class="successful-cet">
				<span>
					<?php echo date('Y-m-d',$time); ?>
				</span>
                <span>
					  <?php echo date('H:s',$time); ?>
				</span>
            </div>
            <div class="successful-bot">
                预计到账时间：
                <span><?php echo date('m',$daotime); ?>月<?php echo date('d',$daotime); ?>日</span>
            </div>
        </div>
        <a href="<?php echo url('user/usertxlist'); ?>" class="r">完成</a>
    </div>
