<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:102:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\user\index.html";i:1573183364;s:105:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\template\base.html";i:1568942460;s:116:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\template\javascript_vars.html";i:1488957233;s:101:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\user\form.html";i:1575965900;s:99:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\user\th.html";i:1573181957;s:99:"D:\phpstudy_pro\WWW\jinli.sxzywl.net\jinli.sxzywl.net\public/../application/admin\view\user\td.html";i:1574833798;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width: 150px" placeholder="开始时间" readonly  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="start_time" <?php echo \think\Request::instance()->param('start_time'); ?>>
    <input type="text" class="input-text" style="width: 150px" placeholder="结束时间" readonly  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="end_time" <?php echo \think\Request::instance()->param('end_time'); ?>>
...
<td><?php if($vo['head_type'] == 1): ?>
    <img src="<?php echo $vo['head']; ?>" alt="" style="width:60px;">
    <?php else: ?>
    <img src="__IMG__/uploads/img/<?php echo $vo['head']; ?>" alt="" style="width:60px;">
    <?php endif; ?>
</td>
...
<td><a href='javascript:layer_open("团队信息","<?php echo url("user/team","",false,true); ?>/id/<?php echo $vo['id']; ?>");'>团队信息</a></td>
<td><a href='javascript:layer_open("消费信息","<?php echo url("user/buy","",false,true); ?>/id/<?php echo $vo['id']; ?>");'>消费信息</a></td>
<td><a href='javascript:layer_open("团队信息","<?php echo url("user/profit","",false,true); ?>/id/<?php echo $vo['id']; ?>");'>收益信息</a></td>
...
<script>
    function ex() {
        $("#form").attr("action", "<?php echo url('user/excel'); ?>");
        $("#form").attr("method", "GET");
        $("#form").submit();
    }

    function ext() {
        $('#form').attr('action',"<?php echo url('user/index'); ?>");
        $('#form').submit();
    }
</script>
