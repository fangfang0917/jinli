<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/course_classify/index.html";i:1575599864;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/base.html";i:1568942460;s:92:"/www/wwwroot/jinli.sxzywl.net/public/../application/admin/view/template/javascript_vars.html";i:1488957233;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="mb-20" method="get" action="<?php echo \think\Url::build(\think\Request::instance()->action()); ?>">
        <input type="text" class="input-text" style="width:250px" placeholder="课程分类标题" name="course_classify_title" value="<?php echo \think\Request::instance()->param('course_classify_title'); ?>">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><img src="<?php echo $vo['course_classify_pic']; ?>" alt="" style="width: 60px;height:120px;"></td>
            ...
            <td class="f-14">
                ...
                <a href="JavaScript:layer_open('查看课程','<?php echo url('Course/index',array('course_classify_id'=>$vo['id'])); ?>');">查看课程</a>
            </td>
        </tr>
