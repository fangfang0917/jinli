<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/course/courseshare.html";i:1572341691;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="share-top">
    <!--<i class="iconfont icon-xiajiantou"></i><a href="javascript:$(function() {$('.share-box').hide()  });">关闭</a>-->
    <span>长按保存图片</span>
</div>
<div class="share-imgbox">
    <img src="__STATIC__/uploads/share/<?php echo $pic['val']; ?>" style="width: 80%;margin: auto;z-index: 1999999;">
</div>
<div class="share-bot" style="display: none;">
    <div class="share-icon">
        <div class="share-img" share-wx="">
            <img src="__STATIC__/index/img/wechat.png">
        </div>
        <span>微信</span>
    </div>
    <div class="share-icon" share-pyq="">
        <div class="share-img">
            <img src="__STATIC__/index/img/life.png">
        </div>
        <span>朋友圈</span>
    </div>
    <div class="share-icon">
        <div class="share-img">
            <img src="__STATIC__/index/img/qq.png">
        </div>
        <span>QQ</span>
    </div>
</div>
