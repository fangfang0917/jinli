<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/amount/amountlists.html";i:1570849686;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="earning-detail-list">
        <div class="earning-detail-list-top">
            <div class="earning-detail-list-left">
                <div id="ser_list" name="ser_list" style="font-size: 13px;text-align: center;line-height:0.8rem;"  data-id="2">
                    本月
                </div>
            </div>
            <div class="earning-detail-list-right">
...
<div id="form" style="display: none">
    <div class="detail-box">
        ...
        <div class="detail-but">
                ...
                <a href="javascript:;" onclick="getlist(2)">
                    完成
                </a>
        </div>
    </div>
