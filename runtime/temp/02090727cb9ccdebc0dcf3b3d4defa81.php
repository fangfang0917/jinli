<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/share.html";i:1576047258;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="share-com">
    ...
    <div class="tiphb">选择海报模板</div>

    <div class="share-rules"  onclick="getequity()">
        规则查看
    </div>
    <div class="share-txt">
        <h1>长按图片保存至相册</h1>
        ...
        <div class="share-btn">
            <div class="share-btnleft">
                <div class="share-btnleft-img"></div>
                <span>上一张</span>
            </div>
            <div class="share-btnright">
                <div class="share-btnleft-img"></div>
                <span>下一张</span>
            </div>
        </div>
    ...
    <div class="share-footer" style="display:none;">
        <a href="javascript:;">页面分享</a>
    </div>
    <div class="FenXiang-duize-tanchuang">
        <div class="FenXiang-duize-tanchuang-top">
            <h1>规则查看</h1>
            <div class="FenXiang-duize-tanchuang-hide" onclick="closeq()"></div>
        </div>
        <div class="FenXiang-duize-tanchuang-con"  style="text-align: left;padding: 0 .5rem">

        </div>
    </div>
</div>
<?php else: ?>
<div class="polite-body" style="height: 100%">
    <div class="polite-imgbox">
        <img src="__STATIC__/index/img/xing.png"/>
    </div>
    <div class="polite-text">
        您还不是会员
    </div>
    <div class="polite-a">
        <a href="javascript:buyVip();">立即成为会员</a>
    </div>
</div>
<?php endif; ?>
...
<script type="text/javascript" src="__STATIC__/index/js/share.js?v=<?php echo time(); ?>"></script>
