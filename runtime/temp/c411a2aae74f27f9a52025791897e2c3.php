...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><?php if($vo['type'] == 1 || $vo['type'] == 2 || $vo['type'] == 5 || $vo['type'] == 4): ?><span style="color: #00B83F">+<?php echo $vo['amount']; ?></span><?php else: ?><span
                    style="color: red">-<?php echo $vo['amount']; ?></span><?php endif; ?>
            </td>
            <td><?php echo date('Y-m-d H:i:s',$vo['add_time']); ?></td>
            <td><?php if($vo['type'] == 1): ?>直推购买返点<?php elseif($vo['type'] == 2): ?>间推购买返点<?php elseif($vo['type']== 3): ?>提现<?php elseif($vo['type'] ==
                4): ?>推荐代理奖<?php elseif($vo['type'] == 5): ?>服务奖<?php endif; ?>
            </td>
            <td><?php if($vo['type'] == 1 || $vo['type'] == 2 || $vo['type'] == 5 || $vo['type'] == 4): ?><span style="color:red ">否</span><?php else: ?><span
                    style="color: #00B83F">是</span><?php endif; ?>
            </td>
            ...
            <td><?php if($vo['type'] == 1 || $vo['type'] == 2 || $vo['type'] == 5 || $vo['type'] == 4): ?><span
                    style="color: #00B83F">--</span><?php else: ?><?php echo date('Y-m-d H:i:s',$vo['up_time']); endif; ?>
            </td>
            <td><?php if($vo['type'] == 1 || $vo['type'] == 2|| $vo['type'] == 5 || $vo['type'] == 4): ?><span style="color: #00B83F">是</span><?php else: ?>否<?php endif; ?>
            </td>
            <td><?php if($vo['type'] == 1 || $vo['type'] == 2|| $vo['type'] == 5 || $vo['type'] == 4): ?><span style="color: #00B83F"><?php echo $vo['snick_name']; ?></span><?php else: ?>--<?php endif; ?>
            </td>
