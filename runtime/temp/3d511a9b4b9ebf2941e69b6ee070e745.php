<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/upphone.html";i:1571472111;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1576223686;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="form-body">
    <div class="form-box">
        <ul class="form-ul">
            <li>
                <input type="text" name="phone" class="" readonly placeholder="请输入手机号" value="<?php echo $userinfo['phone']; ?>" style="color:rgba(153,153,153,1);"/>
                <span class="self-lib-phone-num">手机号</span>
            </li>
            <li class="complete p">
<!--                style="background-color: #FE5B57;pointer-events:auto"-->
                <button class="btn-disabled on r" style="pointer-events:auto"><a href="<?php echo url('user/phone'); ?>">更换手机号</a></button>
            </li>
        </ul>
    </div>
</div>
