...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><?php if($vo['type']==1): ?><?php echo $levelname['level1']; elseif($vo['type'] == 2): ?>锦鲤大使<?php else: ?><?php echo $levelname['level5']; endif; ?></td>
            <td><?php echo $vo['rule_title']; ?></td>
            <td class="f-14">
