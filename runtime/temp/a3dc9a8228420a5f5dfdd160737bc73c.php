<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/user/phone.html";i:1575250206;s:81:"/www/wwwroot/jinli.sxzywl.net/public/../application/index/view/template/base.html";i:1575869481;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="form-body">
    <div class="form-box">
        <ul class="form-ul">
            <li class="self-li">
                <input class="new" type="number" name="phone" placeholder="请输入手机号" value="<?php echo isset($rigU['phone']) ? $rigU['phone'] :  ''; ?>"/>
            </li>
            <li class="yzm-li">
                <input class="new" type="number" name="code" placeholder="请输入验证码" id='codema' value="">
                <button class="self-btn" id="J_GetCode">发送验证码</button>
            </li>
            <li class="complete p">
                <button class="btn-disabled upphone r" _phone>完成</button>
            </li>
        </ul>
    </div>
</div>
...
<div class="form-body">
    <div class="form-box">
        <ul class="form-ul">
            <li class="self-li">
                <input class="new" type="number" name="phone" placeholder="请输入手机号" value=""/>
            </li>
            <li class="yzm-li">
                <input class="new" type="number" name="code" placeholder="请输入验证码" id='codema' value="">
                <button class="self-btn" id="J_GetCode">发送验证码</button>
            ...
            <li class="complete p">
                <button class="btn-disabled r saveUppButton" _phone>完成</button>
            </li>
            <li>
                <div class="Select" style="padding: 0.2rem 0.38rem 0">
                    <div class="Select-but">
                        <img src="__STATIC__/index/img/duigou.png">
                    </div>
                    <span>同意遵循<a href="<?php echo url('about/plat'); ?>">《锦鲤MoM平台用户协议》</a></span>
                </div>
            </li>
        </ul>
    </div>
