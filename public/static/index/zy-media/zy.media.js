    ...
    zyMedia.MediaPlayer.prototype = {
        ...
        buildTimeline: function () {
            ...
            timeline.innerHTML = '<div class="zy_timeline_slider">' +
                ...
                '</div>';
            t.controls.appendChild(timeline);//timeline
        ...
        buildFullscreen: function () {
            ...
            t.doubleBtn = document.createElement('div');
            t.doubleBtn.className = 'zy_double';
            t.controls.appendChild(t.doubleBtn);
            t.doubleBtn.addEventListener('click', function () {
                if ($(".zy_double").hasClass('zy_double_b')) {
                    $(".zy_double").removeClass('zy_double_b');
                    t.media.playbackRate = 1;
                }else{
                    $(".zy_double").addClass('zy_double_b');
